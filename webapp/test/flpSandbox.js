					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vignette SAP S/4 HANA",
									"targetURL": "#vignette-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"vignette-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vignette",
									"url": sap.ui.require.toUrl("vignette")
								}
							}
						}
					}
